(function(){
  const guides={
    ...
    mid:{title:'発注前：中分類総数',press:'① 対象の中分類を開く',check:'② 発注日を見る',capture:'③ 現在庫・納品予定・便別繰越を撮る',cols:['区分','現在庫','納品予定','1便','2便','3便'],rows:[['中分類計','71','38','14','—','—'],['小分類A','34','7','7','12','0']],note:'発注日、中分類名、現在庫、納品予定、便別繰越が一緒に入るように撮影します。'},
